...
export PDATE=${PDATE:-2022050312}	#NetCDF
...
export NWTEST=${NWTEST:-/scratch1/NCEPDEV/da/Edward.Safford/noscrub/GSI-monitor/src/Radiance_Monitor/nwprod}
...
export NDATE=${NDATE:-/scratch2/NCEPDEV/nwprod/hpc-stack/libs/hpc-stack/intel-18.0.5.274/prod_util/1.2.2/bin/ndate}
