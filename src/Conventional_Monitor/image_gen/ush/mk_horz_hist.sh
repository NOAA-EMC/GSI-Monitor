...
#------------------------------------------------------------------
   ...
   export q_TYPE=" q120_00 q130_00 q132_00 q133_00 q134_00 q135_00 q180_00 q181_00 q182_00 q183_00 q187_00 q301_00 q302_00"

   export t_TYPE=" t120_00 t130_00 t131_00 t132_00 t133_00 t134_00 t135_00 t180_00 t181_00 t182_00 t183_00 t187_00 t301_00 t302_00"
   ...
   if [[ ${MY_MACHINE} == "hera" || ${MY_MACHINE} == "orion" || ${MY_MACHINE} == "hercules" ]]; then
      ...
      ${SUB} -A ${ACCOUNT} --ntasks=1 --time=01:30:00 -J ${jobname} -o ${logfile} ${plot_horz_uv}
        ...
        $SUB -V -q ${JOB_QUEUE} -A ${ACCOUNT} -o ${logfile} -e ${logfile} \
                ...
                -l select=1:mem=800M ${plot_horz_uv}
   fi
